...
class FDBPMNContent extends AbstractContent {

	/** @var UUID|null */
	protected $workflowId;
	public function __construct( $contentModel = CONTENT_MODEL_FD_BPMN, UUID $workflowId = null ) {
	...
	public function getTextForSummary( $maxLength = 250 ) {
		return '[Flex Diagrams BPMN ' . $this->getWorkflowId()->getAlphadecimal() . ']';
	}
...
*/
		...
		$parserOutput = new ParserOutput();
		$parserOutput->setText('This is the BPMN!');
/*
