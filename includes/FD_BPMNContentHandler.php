...
class FDBPMNContentHandler extends ContentHandler {
	public function __construct( $modelId ) {
		if ( $modelId !== CONTENT_MODEL_FD_BPMN ) {
			throw new MWException( __CLASS__ . " initialised for invalid content model" );
		}
		parent::__construct( CONTENT_MODEL_FD_BPMN, [ CONTENT_FORMAT_JSON ] );
	}
...
*/
	...
	public function serializeContent( \Content $content, $format = null ) {
		if ( !$content instanceof FDBPMNContent ) {
			throw new MWException( "Expected a FDBPMNContent object, got a " . get_class( $content ) );
		}
		$info = [];
